...
public class StudentActivity extends AppCompatActivity {
    ...
    public StudentList populateStudentDummies(){
        ...
        values.put(StudentContract.COLUMN_STUDENT_NAME,"Andrean");
        values.put(StudentContract.COLUMN_STUDENT_PHONE, "087881123212");
        values.put(StudentContract.COLUMN_STUDENT_GENDER,0);
        values.put(StudentContract.COLUMN_STUDENT_MAIL,"andreanohs@unj.ac.id");
        values.put(StudentContract.COLUMN_STUDENT_NIM,"3145136215");

        long newRowId = db.insert(StudentContract.TABLE_NAME, null, values);

        StudentList studentList = new StudentList();
        studentList.add(new Student("3145136215","Andrean",0,"andreanohs@unj.ac.id","087881123212"));
